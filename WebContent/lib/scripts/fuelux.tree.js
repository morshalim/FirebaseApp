			...
			this.options.dataSource.data($el.data(), function (items) {
				...
				$.each( items.data, function(index, value) {
					...
					if(value.type === "folder") {
						...
						if(value.help){
							$entity.find('.tree-item-name').append('&nbsp;<i class="blue ace-icon fa fa-question-circle bigger-120 ace-popover" data-trigger="hover" data-placement="right" data-content="'+value.help+'"></i>');
							var $pop = $entity.find('.ace-popover');
							//$pop.attr('data-content',value.help);
							$pop.popover();
						}
						$entity.data(value);
